            ...
            <div className="col-lg-6 proaboutname">
               <div className="mt-5 ">
                 <h4 className=" col-lg-12 proaboutdis mb-1">Discover</h4>
                  ...
                  <a className="button" href="https://drive.google.com/file/d/1fXVj89VsIHrLuJZBvUVc7lKdGqt1_1up/view?usp=share_link" download target="_blank" > DOWNLOAD CV <FontAwesomeIcon icon={faCloudArrowDown} /></a></button>                    
               </div>
            </div>
